CREATE TYPE "public"."role" AS ENUM('student', 'professor', 'headmaster');--> statement-breakpoint
...
ALTER TABLE "classes" ADD CONSTRAINT "classes_professor_id_user_id_fk" FOREIGN KEY ("professor_id") REFERENCES "public"."user"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "classes_professor_id_idx" ON "classes" USING btree ("professor_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "account_provider_provider_user_id_key" ON "account" USING btree ("provider_id","provider_user_id");--> statement-breakpoint
